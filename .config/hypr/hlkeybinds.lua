...
--[[ icba to make the popup rn ts pissing me off tho
...
-- Quick Apps --
----------------
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd(_C.terminal)) -- was Kitty, using Alacritty, may use Foot (its cool)
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd(_C.webBrowser)) -- Zen Browser, Dopa type browser
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd(_C.webBrowser .. "--blank-window")) -- Blank Window for quick searches
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(_C.fileManager)) -- Dolphin Default -- check out some other options
hl.bind(mainMod .. " + A",				-- Testing out Fuzzel -- good but minimal.
	hl.dsp.exec_cmd("pkill " .. _C.menu .. " || " .. _C.menu))
